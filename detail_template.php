...
<script type="text/javascript" src="<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/js/custom.js"></script>
     <div id="main">
	<div  class="nduwur"><a class="back" href="javascript: history.back();"><img src="<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/img/back.png" alt="" width="40" height="40"></a>
